...
import com.faist.weatherapp.presentation.search.SearchStore.Intent
import com.faist.weatherapp.presentation.search.SearchStore.Label
import com.faist.weatherapp.presentation.search.SearchStore.State
...
class SearchStoreFactory @Inject constructor(
    ...
    fun create(openReason: OpenReason): SearchStore =
        object : SearchStore, Store<Intent, State, Label> by
        storeFactory.create(
            name = "SearchStore",
            initialState = State(
                searchQuery = "",
